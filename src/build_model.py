...
def build_UNet2D(inp_shape, k_size = 3):
    merge_axis = -1     # feature maps are concatenated along last axis (channel)
                        # width and height stay the same after concatenation
